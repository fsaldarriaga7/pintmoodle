...
class __Mustache_1bd290a8df2c084b5c2604d93a0353cd extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if (empty($value)) {
            ...
            $buffer .= $this->sectionD875e3d74d488800b62b1979520147bb($context, $indent, $value);
            $value = $context->find('haschildren');
            if (empty($value)) {
...
';
    ...
    private function sectionD875e3d74d488800b62b1979520147bb(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
