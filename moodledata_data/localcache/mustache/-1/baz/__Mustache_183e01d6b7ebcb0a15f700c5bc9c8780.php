...
class __Mustache_183e01d6b7ebcb0a15f700c5bc9c8780 extends Mustache_Template
{
...
';
        $buffer .= $indent . '    <a class="btn-gotop" role="button" href="#" aria-label="';
        $value = $context->find('str');
        $buffer .= $this->sectionB79b254d2dc58627443a39ab28f4f9c2($context, $indent, $value);
        $buffer .= '">
';
...
';
        $buffer .= $indent . '</div>
';
        $buffer .= $indent . '<footer id="s-page-footer">
';
        $buffer .= $indent . '    <div class="wrapper-md">
';
        $buffer .= $indent . '
';
...
';
        ...
        $buffer .= $this->section51c48927aa3f0599f1fe3c7eb8c67421($context, $indent, $value);
        $buffer .= $indent . '
';
...
';
        ...
        $buffer .= $this->section10e737be3bfeaae9c3695935cd958385($context, $indent, $value);
...
';
        $buffer .= $indent . '
';
        $value = $context->find('customfloatingbtn');
        $buffer .= $this->section06b769d93acda6af57cdf3ff22de3293($context, $indent, $value);
        $buffer .= $indent . '
';
        $value = $context->find('displaycustomalert');
        $buffer .= $this->section55773137d2480f6d51fabc702b08ef11($context, $indent, $value);
        $value = $context->find('closecustomalert');
        $buffer .= $this->section01d06a8b091cf87127bb496fd6698f9d($context, $indent, $value);
        $buffer .= $indent . '    
';
...
';
    ...
    private function sectionB79b254d2dc58627443a39ab28f4f9c2(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = ' totop, theme_baz ';
...
';
    ...
    private function section51c48927aa3f0599f1fe3c7eb8c67421(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
        <div class="w-100 {{#isfrontpage}}text-center{{/isfrontpage}}{{^isfrontpage}}text-center text-md-left{{/isfrontpage}}">
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                if (empty($value)) {
                    ...
                    $buffer .= 'text-center text-md-left';
                }
                $buffer .= '">
';
...
';
    ...
    private function section10e737be3bfeaae9c3695935cd958385(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section06b769d93acda6af57cdf3ff22de3293(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
<div class="rui-floating-btn">
    {{{customfloatingbtn}}}
</div>
';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '<div class="rui-floating-btn">
';
                $buffer .= $indent . '    ';
                $value = $this->resolveValue($context->find('customfloatingbtn'), $context);
                $buffer .= ($value === null ? '' : $value);
                $buffer .= '
';
                $buffer .= $indent . '</div>
';
    ...
    private function section55773137d2480f6d51fabc702b08ef11(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '        ';
                $value = $this->resolveValue($context->find('customalert'), $context);
                $buffer .= ($value === null ? '' : $value);
                $buffer .= '
';
                $buffer .= $indent . '        </div>
...
';
    ...
    private function section9a927be27878c5dd4ca83a240934e450(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '            }
';
                $buffer .= $indent . '            if (hide === \'true\') {
';
                $buffer .= $indent . '                $(\'.hide_alert\').removeClass(\'show\');
';
                $buffer .= $indent . '            }
';
                $buffer .= $indent . '        });
';
    ...
    private function section01d06a8b091cf87127bb496fd6698f9d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->section9a927be27878c5dd4ca83a240934e450($context, $indent, $value);
                $context->pop();
            }
        }
