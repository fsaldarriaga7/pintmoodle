...
class __Mustache_dc54f4ae022befe654e006f52f9311ea extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionCdba99842e6c282690bddc5587bebd06($context, $indent, $value);
...
';
    ...
    private function sectionDc63433add24dba271268488606e4dfa(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    <a
        href="{{{url}}}"
        class="add-sections btn btn-lg btn-primary mb-3 w-100"
...
';
                ...
                $buffer .= '"
';
                $buffer .= $indent . '        class="add-sections btn btn-lg btn-primary mb-3 w-100"
';
...
';
    ...
    private function sectionCdba99842e6c282690bddc5587bebd06(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->sectionDc63433add24dba271268488606e4dfa($context, $indent, $value);
                $buffer .= $indent . '</div>
';
                $context->pop();
            }
