...
class __Mustache_6f071b506f0d2e599218555310c1eec8 extends Mustache_Template
{
...
';
        ...
        if (empty($value)) {
            ...
            $buffer .= $this->section41d0f7425f7552617b37cc7b645e24e4($context, $indent, $value);
        }
...
';
    ...
    private function section41d0f7425f7552617b37cc7b645e24e4(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
require([\'theme_baz/form-display-errors\'], function(module) {
...
';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . 'require([\'theme_baz/form-display-errors\'], function(module) {
';
