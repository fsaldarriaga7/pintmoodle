...
class __Mustache_10f9d1a05dc7b149c784e2a90a2dc7b3 extends Mustache_Template
{
...
';
        $buffer .= $indent . '    2
';
        $buffer .= $indent . '    <img class="" src="theme/baz/assets/img/MartesTecnicoDigitalLogo.png" alt="Martes Técnico Digital">
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '    ';
