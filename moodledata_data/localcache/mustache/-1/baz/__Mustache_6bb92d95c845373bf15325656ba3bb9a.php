...
class __Mustache_6bb92d95c845373bf15325656ba3bb9a extends Mustache_Template
{
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '    <img class="mt-10 xl:mt-0 xl:pl-0 xl:pr-2" src="theme/baz/assets/img/MartesTecnicoDigitalLogo" alt="Martes Técnico Digital">
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '    ';
