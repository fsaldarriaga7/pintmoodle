...
class __Mustache_a883b2b083c4b77144b814416aae7206 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionEdfa5721baa4eda7530185f204842a57($context, $indent, $value);
...
';
    ...
    private function sectionEdfa5721baa4eda7530185f204842a57(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
require([\'theme_baz/sticky-footer\'], function(footer) {
    footer.init();
});
';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . 'require([\'theme_baz/sticky-footer\'], function(footer) {
';
