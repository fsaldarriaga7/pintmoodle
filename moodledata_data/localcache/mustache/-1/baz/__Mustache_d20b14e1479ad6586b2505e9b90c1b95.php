...
class __Mustache_d20b14e1479ad6586b2505e9b90c1b95 extends Mustache_Template
{
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '    <a>En Vivo</a>
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '    <img class="" src="baz/assets/img/MartesTecnicoDigitalLogo.png" alt="Martes Técnico Digital">
';
        $buffer .= $indent . '    2
';
        $buffer .= $indent . '    <a><img class="" src="theme/baz/assets/img/MartesTecnicoDigitalLogo.png" alt="Martes Técnico Digital"></a>
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '    ';
...
';
        $value = $context->findDot('output.custom_menu');
        $buffer .= $this->sectionB470ecf8767cec4eb0546cddd1c8392e($context, $indent, $value);
        $buffer .= $indent . '
';
...
';
    ...
    private function sectionB470ecf8767cec4eb0546cddd1c8392e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
        <div class="primary-navigation text-black">
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '        <div class="primary-navigation text-black">
';
