...
class __Mustache_e97aac486b4d10f6f5b4ecb187d6867d extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '
';
        $buffer .= $indent . '<nav id="topBar" class="rui-topbar moodle-has-zindex ';
...
';
        ...
        if (empty($value)) {
            ...
            $buffer .= $this->section5578e4ab368272fddfe368c54ab4feef($context, $indent, $value);
        }
        $buffer .= $indent . '
';
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '    <div id="myCoursesBtn" class="rui-topbar-special-btn-container dropdown mr-md-1">
';
        $buffer .= $indent . '        <a class="rui-topbar-special-btn" id="courseUserNav" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" role="button" aria-label="Courses list" class="icon">
';
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '        <div aria-labelledby="courseUserNav" class="dropdown-menu rui-dropdown-course-menu">
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '            ';
        $value = $this->resolveValue($context->findDot('output.baz_mycourses_heading'), $context);
        $buffer .= ($value === null ? '' : $value);
        $buffer .= '
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '            <div class="rui-course-wrapper" data-simplebar data-simplebar-auto-hide="false">';
        $value = $this->resolveValue($context->findDot('output.baz_mycourses'), $context);
        $buffer .= ($value === null ? '' : $value);
        $buffer .= '</div>
';
        $buffer .= $indent . '            ';
        $value = $this->resolveValue($context->findDot('output.baz_allcourseslink'), $context);
        $buffer .= ($value === null ? '' : $value);
        $buffer .= '
';
        $buffer .= $indent . '        </div>
...
';
    ...
    private function section5578e4ab368272fddfe368c54ab4feef(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '            <div class="rui-main-menu-container dropdown mr-2">
';
