...
class __Mustache_bd56b7aab21c4a0727e8a400f90b9a00 extends Mustache_Template
{
...
';
        $buffer .= $indent . '            class="btn btn-icon btn-secondary drawertoggle icon-no-margin"
';
...
';
        ...
        $buffer .= $this->sectionF5fc931be4e67b5d9e9602f47e178587($context, $indent, $value);
    ...
    private function sectionF5fc931be4e67b5d9e9602f47e178587(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
require([\'theme_baz/drawers\']);
';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
            $buffer .= $result;
        } elseif (!empty($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . 'require([\'theme_baz/drawers\']);
';
                $context->pop();
            }
        }
