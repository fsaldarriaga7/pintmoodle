...
class __Mustache_b3ef7f532c79e12e9ed83a88fa927d77 extends Mustache_Template
{
...
';
        $buffer .= $indent . '        
';
        $buffer .= $indent . '        <div id="page" class="d-print-block">
';
        $buffer .= $indent . '
';
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '            <div id="page-report-content" class="page-content wrapper-xxl d-print-block">
';
        $buffer .= $indent . '
';
