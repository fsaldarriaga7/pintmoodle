...
export default class Drawers {
     ...
     *
     * @static
     * @property {String} drawerShow See {@link event:theme_baz/drawers:show}
     * @property {String} drawerShown See {@link event:theme_baz/drawers:shown}
     * @property {String} drawerHide See {@link event:theme_baz/drawers:hide}
     * @property {String} drawerHidden See {@link event:theme_baz/drawers:hidden}
     */
    static eventTypes = {
        /**
         * An event triggered before a drawer is shown.
         *
         * @event theme_baz/drawers:show
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be opened.
         */
        drawerShow: 'theme_baz/drawers:show',

        /**
         * An event triggered after a drawer is shown.
         *
         * @event theme_baz/drawers:shown
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be opened.
         */
        drawerShown: 'theme_baz/drawers:shown',

        /**
         * An event triggered before a drawer is hidden.
         *
         * @event theme_baz/drawers:hide
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be hidden.
         */
        drawerHide: 'theme_baz/drawers:hide',

        /**
         * An event triggered after a drawer is hidden.
         *
         * @event theme_baz/drawers:hidden
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be hidden.
         */
        drawerHidden: 'theme_baz/drawers:hidden',
    };
     ...
     * @returns {module:theme_baz/drawers}
     */
    ...
    openDrawer({focusOnCloseButton = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_baz/drawers:open');
    ...
    closeDrawer({focusOnOpenButton = true, updatePreferences = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_baz/drawers:close');
     ...
     *
     * @param {module:theme_baz/drawers} comparisonInstance
     */
