...
//Theme Settings
$courseimage = theme_baz_get_setting('ipcourseimage');

// Start - Course Image Position
$courseimagesettings = theme_baz_get_setting('setcourseimage');
$courseimagecontent = false;
$courseimagefw = false;
if ($courseimagesettings == 1) {
    $courseimagefw = true;
} else if ($courseimagesettings == 2) {
