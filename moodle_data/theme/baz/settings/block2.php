...
$default = '<div class="rui-card-cat-grid mx-0">
          ...
          <a href="https://demo.rosea.io/baz/1/course/" class="rui-block-category-item">
              ...
              <div class="d-block"><img src="//demo.rosea.io/baz/1/pluginfile.php/1/theme_baz/ruisettingsimgs/0/icon1.png" alt="Icon #1" width="80" height="80" class="img-fluid atto_image_button_text-bottom"></div>
          ...
          <a href="https://demo.rosea.io/baz/1/course/" class="rui-block-category-item">
              ...
              <div class="d-block"><img src="https://demo.rosea.io/baz/1/pluginfile.php/1/theme_baz/ruisettingsimgs/0/icon2.png" alt="Icon #2
      " width="80" height="80" class="img-fluid atto_image_button_text-bottom"></div>
          ...
          <!-- Start item -->
          <a href="https://demo.rosea.io/baz/1/course/" class="rui-block-category-item">
              <div class="d-block"><img src="https://demo.rosea.io/baz/1/pluginfile.php/1/theme_baz/ruisettingsimgs/0/icon3.png" alt="Icon #3" width="80" height="80" class="img-fluid atto_image_button_text-bottom"></div>
          ...
          <!-- Start item -->
          <a href="https://demo.rosea.io/baz/1/course/" class="rui-block-category-item">
              <div class="d-block"><img src="https://demo.rosea.io/baz/1/pluginfile.php/1/theme_baz/ruisettingsimgs/0/icon4.png" alt="Icon #4" width="80" height="80" class="img-fluid atto_image_button_text-bottom"></div>
          ...
          <a href="https://demo.rosea.io/baz/1/course/" class="rui-block-category-item">
              ...
              <div class="d-block"><img src="https://demo.rosea.io/baz/1/pluginfile.php/1/theme_baz/ruisettingsimgs/0/icon5.png" alt="Icon #5" width="80" height="80" class="img-fluid atto_image_button_text-bottom"></div>
          ...
          <!-- Start item -->
          <a href="https://demo.rosea.io/baz/1/course/" class="rui-block-category-item">
              <div class="d-block"><img src="https://demo.rosea.io/baz/1/pluginfile.php/1/theme_baz/ruisettingsimgs/0/icon6.png" alt="Icon #6" width="80" height="80" class="img-fluid atto_image_button_text-bottom"></div>
          ...
          <!-- Start item -->
          <a href="https://demo.rosea.io/baz/1/course/" class="rui-block-category-item">
              <div class="d-block"><img src="https://demo.rosea.io/baz/1/pluginfile.php/1/theme_baz/ruisettingsimgs/0/icon8.png" alt="Icon #7" width="80" height="80" class="img-fluid atto_image_button_text-bottom"></div>
