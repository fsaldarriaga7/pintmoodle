...
$page = new admin_settingpage('theme_baz_block7', get_string('settingsblock7', 'theme_baz'));
          ...
          <div class="rui-card-item col mb-4">
              <div class="rui-card rui-card--with-img">
                  ...
                  <div class="ml-md-4 rui-img--rounded-fluid"><img src="https://demo.rosea.io/baz/1/pluginfile.php/1/theme_baz/ruisettingsimgs/0/img-3d-1-1.png" alt="img #1" width="300" height="300"></div>
              </div>
          </div>
          <!-- End item -->
          ...
          <div class="rui-card-item col mb-4">
              <div class="rui-card rui-card--with-img">
                  ...
                  <div class="ml-md-4 rui-img--rounded-fluid"><img src="https://demo.rosea.io/baz/1/pluginfile.php/1/theme_baz/ruisettingsimgs/0/img-3d-3-1.png" alt="img #1" width="300" height="300"></div>
              </div>
          </div>
          <!-- End item -->
          ...
          <div class="rui-card-item col mb-4">
              <div class="rui-card rui-card--with-img">
                  ...
                  <div class="ml-md-4 rui-img--rounded-fluid"><img src="https://demo.rosea.io/baz/1/pluginfile.php/1/theme_baz/ruisettingsimgs/0/img-3d-4-1.png" alt="img #1" width="300" height="300"></div>
              </div>
          </div>
          <!-- End item -->
          ...
          <div class="rui-card-item col mb-4">
              <div class="rui-card rui-card--with-img">
                  ...
                  <div class="ml-md-4 rui-img--rounded-fluid"><img src="https://demo.rosea.io/baz/1/pluginfile.php/1/theme_baz/ruisettingsimgs/0/img-3d-2-1.png" alt="img #1" width="300" height="300"></div>
              </div>
          </div>
          <!-- End item -->
