...
$page = new admin_settingpage('theme_baz_block8', get_string('settingsblock8', 'theme_baz'));
          ...
          <div class="rui-card-item col mb-4">
              <div class="rui-card d-block d-md-inline-flex align-items-center border-0" style="background: #eeead4;">
                  <div class="rui-card-item-img rui-img--rounded-fluid mr-md-2"><img src="https://demo.rosea.io/baz/1/pluginfile.php/1/theme_baz/ruisettingsimgs/0/download.jpg" alt="pic 1" width="400" height="400"></div>
          ...
          <div class="rui-card-item col mb-4">
              <div class="rui-card d-block d-md-inline-flex align-items-center border-0" style="background: #c1d3d3;">
                  <div class="rui-card-item-img rui-img--rounded-fluid mr-md-2"><img src="https://demo.rosea.io/baz/1/pluginfile.php/1/theme_baz/ruisettingsimgs/0/sq-2.jpg" alt="pic 2" width="400" height="400"></div>
                  <div class="rui-card-body mt-3 mt-md-0 col">
          ...
          <div class="rui-card-item col mb-4">
              <div class="rui-card d-block d-md-inline-flex align-items-center border-0" style="background: #dcd5d9;">
                  <div class="rui-card-item-img rui-img--rounded-fluid mr-md-2"><img src="https://demo.rosea.io/baz/1/pluginfile.php/1/theme_baz/ruisettingsimgs/0/sq-3.jpg" alt="pic 3" width="400" height="400"></div>
                  <div class="rui-card-body mt-3 mt-md-0 col">
          ...
          <div class="rui-card-item col mb-4">
              <div class="rui-card d-block d-md-inline-flex align-items-center border-0" style="background: #cdd6c1;">
                  <div class="rui-card-item-img rui-img--rounded-fluid mr-md-2"><img src="https://demo.rosea.io/baz/1/pluginfile.php/1/theme_baz/ruisettingsimgs/0/sq-5.jpg" alt="pic 4" width="400" height="400"></div>
                  <div class="rui-card-body mt-3 mt-md-0 col">
