...
$default = '<div class="wrapper-xxl">
          ...
          <div class="row my-5">
              <div class="col-xs-12 col-md-6 rui-img--rounded-fluid">
                  <img src="https://demo.rosea.io/baz/1/pluginfile.php/1/theme_baz/ruisettingsimgs/0/simg-1.jpeg" alt="pic #1" width="600" height="472">
              </div>
          ...
          <div class="row my-5">
              ...
              <div class="col-xs-12 col-md-6 rui-img--rounded-fluid">
                  <img src="https://demo.rosea.io/baz/1/pluginfile.php/1/theme_baz/ruisettingsimgs/0/simg-2.png" alt="pic #2" width="600" height="472">
              </div>
          </div>
          <!-- End item -->
          ...
          <div class="row my-5">
              <div class="col-xs-12 col-md-6 rui-img--rounded-fluid">
                  <img src="https://demo.rosea.io/baz/1/pluginfile.php/1/theme_baz/ruisettingsimgs/0/simg-3.jpeg" alt="pic #4" width="600" height="472">
              </div>
              <div class="col-xs-12 col-md-6 d-flex flex-wrap align-content-center px-lg-6">
                  <div>
